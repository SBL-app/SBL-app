...
// `Notification` peut être absent (navigateurs anciens, environnement de test) :
// on lit sa permission de façon défensive pour ne pas planter au chargement du module.
